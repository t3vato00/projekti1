...
else:win32:CONFIG(debug, debug|release): LIBS += -L$$PWD/../../build-qextserialport-Desktop_Qt_5_2_1_MinGW_32bit-Release/debug/ -lQt5ExtSerialPortd1 -L$$PWD/../../build-rfid-Desktop_Qt_5_2_1_MinGW_32bit-Release/release/ -lrfid_reader_dll
